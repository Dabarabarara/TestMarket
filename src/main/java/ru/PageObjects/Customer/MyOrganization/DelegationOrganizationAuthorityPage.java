...
/**
 * Класс для работы со страницей [Делегирование доступа организации]
 * ( Моя организация / Полномочия партнеров в моих закупках / Кнопка [Делегировать полномочия] )
 ...
 */
public class DelegationOrganizationAuthorityPage extends CommonCustomerPage {
    /*******************************************************************************************************************
     * Поля класса.
     ******************************************************************************************************************/
     ...
     ******************************************************************************************************************/
    public DelegationOrganizationAuthorityPage(WebDriver driver) {
        super(driver);
        //--------------------------------------------------------------------------------------------------------------
        ...
        //--------------------------------------------------------------------------------------------------------------
        controls.add("Делегировать доступ", "BaseMainContent_MainContent_lbSend");
        //--------------------------------------------------------------------------------------------------------------
    }
     ...
     * @return страница [Делегирование доступа организации]
     */
    public DelegationOrganizationAuthorityPage verifyField(String fieldName, String value) {
     ...
     * @return страница [Делегирование доступа организации]
     */
    public DelegationOrganizationAuthorityPage setField(String fieldName, String value) throws Exception {
        SelenideElement field = $(this.getBy(controls.find(fieldName)));
     ...
     * @return страница [Делегирование доступа организации]
     */
    public DelegationOrganizationAuthorityPage clickOnButton(String buttonName) throws Exception {
     ...
     * @return страница [Делегирование доступа организации]
     */
    public DelegationOrganizationAuthorityPage setCheckBoxValue(String checkBoxName) {
     ...
     * @return страница [Делегирование доступа организации]
     */
    public DelegationOrganizationAuthorityPage verifyCheckBoxNotSelected(String checkBoxName) {
        Assert.assertFalse(
