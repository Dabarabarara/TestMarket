...
/**
 * Этот класс содержит методы для связывания неконкурентной закупки - Аукцион с номером от ЕИС с помощью генерации
 * .xml-ответа от ЕИС.
 * Created by Kirill G. Rydzyvylo on 04.06.2020.
 * Updated by Vladimir V. Klochkov on 25.02.2021.
 */
public class CreateEisPublishedUncompetitiveProcurementAuctionNotice extends CreateEisPublishedNotice {
    /*******************************************************************************************************************
     * Методы класса.
     ******************************************************************************************************************/
    /**
