...
/**
 * Этот класс содержит методы для связывания конкурентной закупки - Конкурса ( заявка в двух частях )
 * с номером от ЕИС с помощью генерации .xml-ответа от ЕИС.
 * Created by Kirill G. Rydzyvylo on 09.10.2020.
 * Updated by Vladimir V. Klochkov on 25.02.2021.
 */
public class CreateEisPublishedCompetitiveProcurementTenderApplicationInTwoPartsNotice extends CreateEisPublishedNotice {
    /*******************************************************************************************************************
     * Методы класса.
     ******************************************************************************************************************/
    /**
    ...
    public String updateModel(String model) throws Exception {
        ...
        params.put("{ns2:item:customer:purchaseCodeName}", "К2Ч конкурентный");
