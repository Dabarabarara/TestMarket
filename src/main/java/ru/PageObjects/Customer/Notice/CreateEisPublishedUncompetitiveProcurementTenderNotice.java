...
/**
 * Этот класс содержит методы для связывания неконкурентной закупки - Конкурс с номером от ЕИС с помощью генерации
 * .xml-ответа от ЕИС.
 * Created by Kirill G. Rydzyvylo on 18.06.2020.
 * Updated by Vladimir V. Klochkov on 25.02.2021.
 */
public class CreateEisPublishedUncompetitiveProcurementTenderNotice extends CreateEisPublishedNotice {
    /*******************************************************************************************************************
     * Методы класса.
     ******************************************************************************************************************/
    /**
