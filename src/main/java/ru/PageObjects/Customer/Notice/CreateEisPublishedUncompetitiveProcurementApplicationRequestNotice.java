...
/**
 * Этот класс содержит методы для связывания неконкурентной закупки - Запрос предложений с номером от ЕИС с помощью генерации
 * .xml-ответа от ЕИС.
 * Created by Alexander S. Vasyurenko on 11.11.2020.
 * Updated by Vladimir V. Klochkov on 25.02.2021.
 */
public class CreateEisPublishedUncompetitiveProcurementApplicationRequestNotice extends CreateEisPublishedNotice {
    /*******************************************************************************************************************
     * Методы класса.
     ******************************************************************************************************************/
    /**
