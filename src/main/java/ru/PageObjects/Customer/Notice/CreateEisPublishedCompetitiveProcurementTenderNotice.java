...
/**
 * Этот класс содержит методы для связывания конкурентной закупки - Конкурса с номером от ЕИС с помощью генерации
 * .xml-ответа от ЕИС.
 * Created by Vladimir V. Klochkov on 02.08.2018.
 * Updated by Vladimir V. Klochkov on 25.02.2021.
 */
public class CreateEisPublishedCompetitiveProcurementTenderNotice extends CreateEisPublishedNotice {
    /*******************************************************************************************************************
     * Методы класса.
     ******************************************************************************************************************/
    /**
    ...
    public String updateModel(String model) throws Exception {
        ...
        params.put("{ns2:item:customer:purchaseCodeName}", "Типовой К в ЭФ");
