...
/**
 * Этот класс содержит методы для связывания конкурентной закупки - Аукцион ( заявка в двух частях )
 * от ЕИС с помощью генерации
 * .xml-ответа от ЕИС.
 * Created by Kirill G. Rydzyvylo on 26.10.2020.
 * Updated by Vladimir V. Klochkov on 25.02.2021.
 */
public class CreateEisPublishedCompetitiveProcurementAuctionApplicationInTwoPartsNotice extends CreateEisPublishedNotice {
    /*******************************************************************************************************************
     * Методы класса.
     ******************************************************************************************************************/
    /**
