...
/**
 * Этот класс содержит методы для связывания конкурентной закупки - Аукцион с несколькими лотами с номером
 * от ЕИС с помощью генерации
 * .xml-ответа от ЕИС.
 * Created by Kirill G. Rydzyvylo on 26.08.2020.
 * Updated by Vladimir V. Klochkov on 25.02.2021.
 */
public class CreateEisPublishedCompetitiveProcurementAuctionWithSeveralLotsNotice extends CreateEisPublishedNotice {
    /*******************************************************************************************************************
     * Методы класса.
     ******************************************************************************************************************/
    /**
    ...
    public String updateModel(String model) throws Exception {
        ...
        params.put("{ns2:item:placingProcedure:examinationPlace}", "325325, Российская Федерация, Респ. Дагестан, " +
                "Ахвахский р-н, с. Карата, Строителей, 3, ОКАТО: 82205830001");
        params.put("{ns2:item:placingProcedure:examinationDateTime}",
                timer.dateToResponseFormatWithSeconds(publishNoticeDate, 2));
        ...
        params.put("{ns2:item:lotData:subject2}", "Лот 2");
