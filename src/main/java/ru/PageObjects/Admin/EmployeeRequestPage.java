...
/**
 * Класс для работы со страницей [Заявка на изменение информации о пользователе]
 ...
 */
public class EmployeeRequestPage extends CommonAdminPage {
    /*******************************************************************************************************************
    ...
    //------------------------------------------------------------------------------------------------------------------
    // Таблица [Сертификаты] столбец [Данные сертификаты]
    ...
    public void checkNumberOfRowsInCertificatesTable(String rows) throws Exception {
        ...
        System.out.printf("[ИНФОРМАЦИЯ]: произведена проверка количества строк [%s] в таблице [Сертификаты].%n", rows);
    }
