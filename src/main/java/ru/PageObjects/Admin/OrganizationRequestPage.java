...
/**
 * Класс описывающий страницу [Заявка на добавление пользователя в организацию ...]
 * ( .kontur.ru/supplier/lk/Accreditation/EmployeeRequest.aspx?OrganizationId ).
 * Created by Kirill G. Rydzyvylo on 17.08.2020.
 * Updated by Vladimir V. Klochkov on 10.03.2021.
 */
public class OrganizationRequestPage extends CommonSupplierPage {
    /*******************************************************************************************************************
     ...
     ******************************************************************************************************************/
    public OrganizationRequestPage(WebDriver driver) {
        super(driver);
        //--------------------------------------------------------------------------------------------------------------
