...
/**
 * Класс-контейнер для хранения информации о наборе параметров для файла-шаблона ZPEMSP.xml
 * ( создание извещения об обычном запросе предложений МСП ).
 * Created by Vladimir V. Klochkov on 13.05.2019.
 * Updated by Vladimir V. Klochkov on 24.06.2020.
 */
public class RzhdSMBRFPCreate {
    /*******************************************************************************************************************
     * Поля класса.
     ******************************************************************************************************************/
     ...
     ******************************************************************************************************************/
    /**
     * Возвращает набор параметров для файла-шаблона ZPEMSP.xml.
     *
     * @return набор параметров для файла-шаблона ZPEMSP.xml
     */
    public HashMap<String, String> getParams() {
        return new HashMap<String, String>() {{
            ...
            //
            put("ns2:name", config.getConfigParameter("RzhdPurchaseNameForRequestForProposalsCreate"));
            //
            ...
            //
            put("ns2:summingupDateTime", timer.dateToResponseFormatWithSeconds(Timer.getPublishNoticeDate(), 5));
            //
            ...
            put("//integrCode[contains(., 'etzpNoticeNumber')]/../value/string",
                    String.format("Rzhd SMB - Request For Proposals Usual %s",
            ...
            put("//integrCode[contains(., 'ProvisionRequirements')]/../value/string",
                    config.getConfigParameter("RzhdProvisionRequirementsCreate"));
            //
            // Обеспечение заявки
            //
            put("//integrCode[contains(., 'Deposit')]/../value/number", config.getConfigParameter("RzhdDeposit"));
            //
