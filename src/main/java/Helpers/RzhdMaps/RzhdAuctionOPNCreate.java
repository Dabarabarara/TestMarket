...
/**
 * Класс-контейнер для хранения информации о наборе параметров для файла-шаблона OAE.xml
 * ( создание извещения об открытом электронном аукционе ).
 * Created by Vladimir V. Klochkov on 04.06.2019.
 * Updated by Vladimir V. Klochkov on 24.06.2020.
 */
public class RzhdAuctionOPNCreate {
    /*******************************************************************************************************************
     * Поля класса.
     ******************************************************************************************************************/
     ...
     ******************************************************************************************************************/
    /**
     * Возвращает набор параметров для файла-шаблона OAE.xml.
     *
     * @return набор параметров для файла-шаблона OAE.xml
     */
    public HashMap<String, String> getParams() {
        return new HashMap<String, String>() {{
            ...
            //
            put("ns2:name", config.getConfigParameter("RzhdPurchaseNameForAuctionOPNCreate"));
            //
            ...
            put(lr, String.format("Rzhd - Auction With Open Access %s",
