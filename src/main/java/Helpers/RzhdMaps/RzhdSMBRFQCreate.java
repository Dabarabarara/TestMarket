 ...
 * ( создание извещения об обычном запросе котировок МСП ).
 * Created by Vladimir V. Klochkov on 15.04.2019.
 * Updated by Vladimir V. Klochkov on 24.06.2020.
 */
public class RzhdSMBRFQCreate {
    /*******************************************************************************************************************
     * Поля класса.
     ******************************************************************************************************************/
    ...
    public HashMap<String, String> getParams() {
        return new HashMap<String, String>() {{
            ...
            //
            put("ns2:name", config.getConfigParameter("RzhdPurchaseNameForRequestForQuotationsCreate"));
            //
            ...
            //
            put("ns2:summingupDateTime", timer.dateToResponseFormatWithSeconds(Timer.getPublishNoticeDate(), 3));
            //
