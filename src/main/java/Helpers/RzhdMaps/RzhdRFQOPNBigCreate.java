 ...
 * ( создание извещения об открытом электронном запросе котировок ).
 * Created by Vladimir V. Klochkov on 30.08.2019.
 * Updated by Vladimir V. Klochkov on 24.06.2020.
 */
public class RzhdRFQOPNBigCreate {
    /*******************************************************************************************************************
     * Поля класса.
     ******************************************************************************************************************/
    ...
    public HashMap<String, String> getParams() {
        return new HashMap<String, String>() {{
            ...
            //
            put("ns2:name", config.getConfigParameter("RzhdPurchaseNameForRequestForQuotationsOPNCreate"));
            //
            ...
            put(lr, String.format("Rzhd - Request For Quotations With Open Access And Big File %s",
