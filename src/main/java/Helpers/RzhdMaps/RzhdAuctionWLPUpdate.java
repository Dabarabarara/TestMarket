 ...
 * ( обновление извещения об аукционе с ограниченным участием ).
 * Created by Vladimir V. Klochkov on 20.05.2019.
 * Updated by Vladimir V. Klochkov on 24.06.2020.
 */
public class RzhdAuctionWLPUpdate {
    /*******************************************************************************************************************
     * Поля класса.
     ******************************************************************************************************************/
    ...
    public HashMap<String, String> getParams() {
        return new HashMap<String, String>() {{
            ...
            //
            put("ns2:name", config.getConfigParameter("RzhdPurchaseNameForAuctionWLPUpdate"));
            //
            ...
            put(lr, timer.dateToResponseFormatWithSeconds(Timer.getPublishNoticeDate(1), 6));
            //
