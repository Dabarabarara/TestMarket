...
public class RzhdSMBAuctionCreate {
    ...
    public HashMap<String, String> getParams() {
        return new HashMap<String, String>() {{
            ...
            //
            put("ns2:name", config.getConfigParameter("RzhdPurchaseNameForAuctionCreate"));
            //
            ...
            put("//integrCode[contains(., 'pricesProvisionEndDate')]/../value/dateTime",
                    timer.dateToResponseFormatWithSeconds(Timer.getPublishNoticeDate(), Calendar.MINUTE, 10));
            //
