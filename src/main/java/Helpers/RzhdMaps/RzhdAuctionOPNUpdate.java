...
public class RzhdAuctionOPNUpdate {
    ...
    public HashMap<String, String> getParams() {
        return new HashMap<String, String>() {{
            ...
            //
            put("ns2:name", config.getConfigParameter("RzhdPurchaseNameForAuctionOPNUpdate"));
            //
