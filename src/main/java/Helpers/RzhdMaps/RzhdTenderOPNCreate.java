...
/**
 * Класс-контейнер для хранения информации о наборе параметров для файла-шаблона OKE.xml
 * ( создание извещения об открытом электронном конкурсе ).
 * Created by Vladimir V. Klochkov on 11.06.2019.
 * Updated by Vladimir V. Klochkov on 24.06.2020.
 */
public class RzhdTenderOPNCreate {
    /*******************************************************************************************************************
     * Поля класса.
     ******************************************************************************************************************/
     ...
     ******************************************************************************************************************/
    /**
     * Возвращает набор параметров для файла-шаблона OKE.xml.
     *
     * @return набор параметров для файла-шаблона OKE.xml
     */
    public HashMap<String, String> getParams() {
        return new HashMap<String, String>() {{
            ...
            //
            put("ns2:name", config.getConfigParameter("RzhdPurchaseNameForTenderOPNCreate"));
            //
            ...
            put(lr, String.format("Rzhd - Tender With Open Access %s",
