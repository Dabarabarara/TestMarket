...
public class RzhdSMBTenderUpdate {
    ...
    public HashMap<String, String> getParams() {
        return new HashMap<String, String>() {{
            ...
            //
            put("ns2:name", config.getConfigParameter("RzhdPurchaseNameForTenderUpdate"));
            //
            ...
            // Обеспечение заявки
            //
            put("//integrCode[contains(., 'Deposit')]/../value/number",
                    config.getConfigParameter("RzhdZeroDeposit"));
            //
