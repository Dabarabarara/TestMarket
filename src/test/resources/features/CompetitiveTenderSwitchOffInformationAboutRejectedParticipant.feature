@smoke @runTest @comp_tender_switch_off_chbox_spec_info_about_all_rej_participants
Feature: Competitive Tender Switch Off Information About Rejected Participant
  #=====================================================================================================================
  # Проверка настройки «В любом протоколе при отправке в ЕИС указывать информацию обо всех отклоненных участниках лота
  # (кроме МСП закупок, аукционов и редукционов в одной и двух частях)» настройка выключена
  # ( https://ve-lab.visualstudio.com/kontur.market/_workitems/edit/343704 )
  ...
  #=====================================================================================================================
  Scenario: Конкурс конкурентный с отправкой в ЕИС, "В любом протоколе при отправке в ЕИС указывать информацию обо всех отклоненных участниках лота" настройка выключена
    Given Параметру 'Тип теста' установлено значение "Competitive Tender Checkbox Specify Information About All Rejected Participants Switch Off"
    ...
    And 'Заказчик' проверяет что флаг "В любом протоколе при отправке в ЕИС указывать информацию обо всех отклоненных участниках лота (кроме МСП закупок, аукционов и редукционов в одной и двух частях)" на странице 'Общие настройки' "выключена"
    #*******************************************************************************************************************
    #
    ...
    And 'Заказчик А' заполняет поле 'Наименование закупки' сгенерированным именем для типа закупки "Конкурс - Конкурентн. не указывать информацию обо всех отклоненных участниках лота"
    ...
    And 'Заказчик' проверяет количество строк 2 в таблице 'Сведения протокола подведения итогов'
    #*******************************************************************************************************************
    #
