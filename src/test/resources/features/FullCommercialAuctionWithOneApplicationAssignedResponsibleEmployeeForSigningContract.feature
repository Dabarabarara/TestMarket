@smoke @runTest @full_comm_auct_ws_1_appl_and_assigned_resp_empl_4_sign_contract
Feature: Full Commercial Auction With One Application and Assigned Responsible Employee For Signing Contract
  #=====================================================================================================================
  # Полный электронный коммерческий аукцион с использованием ускорения процедур и одной заявкой ( без торгов ) -
  # Назначение ответственного за заключение договора. Тип назначаемого ответственного – "Сотрудники".
  # ( https://ve-lab.visualstudio.com/kontur.market/_workitems/edit/337703 )
  # В системе созданы следующие пользователи:
  # Заказчик 1                  - "Заказчик Юридическое лицо 4 сотрудник 1"
  # Заказчик 2                  - "Заказчик Юридическое лицо 4 сотрудник 2"
  # Поставщик 1                - "Поставщик Юридическое лицо 1"
  # Администратор ( Оператор ) - "Администратор"
  #=====================================================================================================================
  Scenario: Назначение ответственного за заключение договора. Тип назначаемого ответственного – "Сотрудники".
    Given Параметру 'Тип теста' установлено значение "Commercial Auction With One Application and Assigned Responsible Employee For Signing Contract"
    And Все требуемые для теста сертификаты присутствуют на компьютере
    #*******************************************************************************************************************
    #
    #               Заказчик 3 Сотрудник 2 проверяет "Настройки договоров и доп. соглашений" в разделе "ОБЩИЕ НАСТРОЙКИ"
    #
    #*******************************************************************************************************************
    When "Заказчик 3 Сотрудник 2" заходит в личный кабинет
    ...
    And 'Заказчик' проверяет что флаг "Назначать ответственного для подписания договора" на странице 'Общие настройки' "включен"
    #*******************************************************************************************************************
    #
    #                 Заказчик 3 Сотрудник 2 публикует извещение о проведении коммерческого аукциона
    #
    #*******************************************************************************************************************
    ...
    And 'Заказчик А' проверяет, что поле "Фамилия" содержит значение "ЗАКАЗЧИК4ALL223"
    And 'Заказчик А' проверяет, что поле "Имя" содержит значение "СОТРУДНИК2"
    And 'Заказчик А' проверяет, что поле "Отчество" содержит значение "ЮЛ3"
    ...
    #-------------------------------------------------------------------------------------------------------------------
    #                 Заказчик 2 проверяет статус закупки и статус лота
    #-------------------------------------------------------------------------------------------------------------------
    ...
    And 'Пользователь' покидает систему
    #-------------------------------------------------------------------------------------------------------------------
    #                 Заказчик 2 публикует протокол рассмотрения заявок
    #-------------------------------------------------------------------------------------------------------------------
    When "Заказчик 3 Сотрудник 2" заходит в личный кабинет
    ...
    #*******************************************************************************************************************
    #
    #                 Заказчик 2 направляет договор Поставщику 1
    #
    #*******************************************************************************************************************
    And 'Заказчик' переходит на страницу 'Мои закупки' и ищет опубликованное извещение
    ...
    #-------------------------------------------------------------------------------------------------------------------
    #                 Заказчик 2 назначает ответственного для подписания договора
    #-------------------------------------------------------------------------------------------------------------------
    And 'Заказчик' нажимает на кнопку "Назначить ответственного для подписания" на странице 'Сведения о договоре'
    And 'Заказчик' назначает сотрудника "ЗАКАЗЧИК4ALL223 СОТРУДНИК1" ответственным за подписание договора
    And 'Заказчик' проверяет наличие кнопки "Переназначить ответственного для подписания" на странице 'Сведения о договоре'
    And 'Заказчик' нажимает на кнопку "История" на странице 'Сведения о договоре'
    ...
    #*******************************************************************************************************************
    #
    #                 Заказчик 2 проверяет, что не может подписать договор
    #
    #*******************************************************************************************************************
    When "Заказчик 3 Сотрудник 2" заходит в личный кабинет
    ...
    And 'Заказчик' переходит к просмотру раздела договора "Сведения о договоре"
    And 'Заказчик' проверяет отсутствие кнопки "Подписать договор" на странице 'Сведения о договоре'
    And 'Пользователь' покидает систему
    #*******************************************************************************************************************
    #
    #                 Заказчик 1 подписывает договор
    #
    #*******************************************************************************************************************
    When "Заказчик 3 Сотрудник 1" заходит в личный кабинет
    And 'Заказчик' переходит на страницу "УВЕДОМЛЕНИЯ/ВХОДЯЩИЕ"
    And 'Заказчик' проверяет последнее из входящих уведомлений "Назначение ответственного для подписания договора по закупке № %s (лот № 1)" по номеру закупки
    ...
    And 'Заказчик' переходит по ссылке "Ссылка Вы назначены ответственным для подписания договора по закупке" на странице 'Просмотр сообщения'
    And 'Заказчик' проверяет, что открыта страница "Заказчик-Подпишите договор"
    And 'Заказчик' переходит к просмотру раздела договора "Сведения о договоре"
    ...
    #*******************************************************************************************************************
    #
    #             Заказчик 2 проверяет, что закупка завершена
    #
    #*******************************************************************************************************************
    When "Заказчик 3 Сотрудник 2" заходит в личный кабинет
    #                 Лот № 1
