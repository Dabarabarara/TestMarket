@smoke @runTest @joint_auction_comm_organizer_is_among_customers
Feature: Joint auction (commercial) - organizer is among customers
  #=====================================================================================================================
  # Проведение совместного аукциона ( коммерческий ) - организатор среди заказчиков
  # ( https://ve-lab.visualstudio.com/kontur.market/_workitems/edit/337531 )
  ...
  #=====================================================================================================================
  Scenario: Проведение совместного аукциона ( коммерческий ) - организатор среди заказчиков
    Given Параметру 'Тип теста' установлено значение "Joint Auction Commercial Organizer Is Among Customers"
    ...
    #
    #                 Добавляем первую организацию - Заказчика-организатора ( будет указан в таблице договора )
    #
    ...
    #
    #                 Добавляем вторую организацию - Заказчика-уполномоченное лицо 1 ( будет указан в таблице договора )
    #
    ...
    #*******************************************************************************************************************
    #
    #                 Заключение договора между Заказчиком-организатором и Поставщиком 1
    #
    #*******************************************************************************************************************
    When "Заказчик Юридическое лицо 5" заходит в личный кабинет
    And 'Заказчик' заполняет поле 'Номер закупки' и нажимает на кнопку 'Поиск'
    ...
    And 'Заказчик' проверяет ячейку "Заказчик" строка "1" в таблице 'Договоры закупки' на текст "ООО Автотестеры 223 ЮЛ 5 СОТР 1"
    And 'Заказчик' проверяет ячейку "Заказчик" строка "2" в таблице 'Договоры закупки' на текст "ООО Автотестеры 223 ЮЛ 6 СОТР 1"
    ...
    And 'Пользователь' покидает систему
    #-------------------------------------------------------------------------------------------------------------------
    #                 Заказчик-организатор подписывает договор с Поставщиком 1
    #                 Лот № 1
    #-------------------------------------------------------------------------------------------------------------------
    When "Заказчик Юридическое лицо 5" заходит в личный кабинет
