@smoke @accreditation @accreditation_legal_entity_as_customer_and_supplier
Feature: Accreditation Legal Entity As Customer And Supplier
  #=====================================================================================================================
  # Первичная аккредитация [ Юридическое лицо ] в ролях [ Заказчик ] и [ Поставщик ]
  ...
  #=====================================================================================================================
  Scenario: Первичная аккредитация Юридического лица в ролях Поставщика и Заказчика
