@smoke @runTest @add_user_from_customer_personal_area
Feature: Add User From Customer Personal Area
  #=====================================================================================================================
  # Добавление пользователя из личного кабинета Заказчика ( Заказчик )
  ...
  #=====================================================================================================================
  Scenario: Добавление пользователя из личного кабинета Заказчика ( Заказчик )
    ...
    And 'Заказчик' нажимает на кнопку 'Добавить пользователя' на странице 'Список пользователей'
    ...
    And 'Заказчик' проверяет, что таблица на странице 'Список пользователей' содержит 2 строки
    And 'Пользователь' покидает систему
    #*******************************************************************************************************************
    #
    #                 Заказчик авторизуется добавленным пользователем
    #
    #*******************************************************************************************************************
    ...
    #
    #*******************************************************************************************************************
    When 'Заказчик' проверяет, что открыта страница "Информация о пользователе - Заказчик"
