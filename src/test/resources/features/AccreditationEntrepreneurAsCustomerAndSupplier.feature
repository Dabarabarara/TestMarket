@smoke @accreditation @accreditation_entrepreneur_as_customer_and_supplier
Feature: Accreditation Entrepreneur As Customer And Supplier
  #=====================================================================================================================
  # Первичная аккредитация [ Индивидуальный предприниматель ] в ролях [ Заказчик ] и [ Поставщик ]
  # ( https://ve-lab.visualstudio.com/kontur.market/_workitems/edit/278607 )
  ...
  #=====================================================================================================================
  Scenario: Первичная аккредитация Индивидуального предпринимателя в ролях Поставщика и Заказчика
