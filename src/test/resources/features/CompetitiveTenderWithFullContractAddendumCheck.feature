@smoke @runTest @competitive_tender_with_full_contract_addendum_check
Feature: Competitive Tender With Full Contract Addendum Check
  #=====================================================================================================================
  # Проведение конкурентного конкурса с проверкой заключения доп. соглашения
  # ( https://ve-lab.visualstudio.com/kontur.market/_workitems/edit/345674 )
  ...
  #=====================================================================================================================
  Scenario: Проведение конкурентного конкурса с проверкой заключения доп. соглашения
    Given Параметру 'Тип теста' установлено значение "Competitive Tender With Full Contract Addendum Check"
    ...
    #*******************************************************************************************************************
    #
    #                 Заказчик направляет дополнительное соглашение Поставщику 1
    #
    #*******************************************************************************************************************
    And 'Заказчик' переходит на страницу "ДОГОВОРЫ/ДОГОВОРЫ" с именем URL для проверки "Мои контракты"
    And 'Заказчик' выполняет поиск 1 договоров по номеру извещения
    And 'Заказчик' открывает страницу 'Сведения о договоре' по ссылке на номер карточки договора
    And 'Заказчик' проверяет, что открыта страница "Заказчик-Подпишите договор"
    And 'Заказчик' нажимает на кнопку "Создать доп. соглашение" на странице 'Сведения о договоре'
    And 'Заказчик' проверяет, что открыта страница "Заказчик-Подпишите договор"
    #
    #               Проверка раздела [Сведения о договоре (дополнительном соглашении)]
    #
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Сведения о договоре (дополнительном соглашении)"
    And 'Заказчик' нажимает на кнопку "Ссылка на основной договор" на странице 'Сведения о дополнительном соглашении'
    ...
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Сведения о договоре (дополнительном соглашении)"
    And 'Заказчик' проверяет статус дополнительного соглашения "Договор формируется"
    ...
    And 'Заказчик' проверяет что поле доп. соглашения 'Сумма договора с учетом доп. соглашений' содержит значение "4,00 (Российский рубль)"
    And 'Заказчик' нажимает на кнопку "Изменить цену договора" на странице 'Сведения о дополнительном соглашении'
    ...
    And 'Заказчик' проверяет что поле доп. соглашения 'Сумма договора с учетом доп. соглашений' содержит значение "5,00 (Российский рубль)"
    And 'Заказчик' проверяет, что флажок "Прекращение обязательств сторон" "не установлен" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что флажок "Возможность продления срока действия доп. соглашения" "не установлен" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Дата начала исполнения дополнительного соглашения" содержит пустое значение на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Условия начала исполнения дополнительного соглашения" содержит пустое значение на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Дата окончания исполнения дополнительного соглашения" содержит пустое значение на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Условия окончания исполнения дополнительного соглашения" содержит пустое значение на странице 'Сведения о дополнительном соглашении'
    #
    #               Проверка раздела [Сведения о заключении договора (дополнительного соглашения)]
    #
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Сведения о заключении договора (дополнительного соглашения)"
    And 'Заказчик' проверяет, что поле "Дата публикации протокола подведения итогов" соответствует шаблону "dd.MM.yyyy HH:mm:ss" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Дата создания карточки" соответствует шаблону "dd.MM.yyyy HH:mm:ss" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик А' проверяет, что переключатель "c даты получения проекта договора поставщиком" не отмечен на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик А' проверяет, что переключатель "установить дату вручную" не отмечен на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Дата направления дополнительного соглашения участнику" содержит пустое значение на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Дата подписания дополнительного соглашения участником" не заполнено на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Дата подписания дополнительного соглашения заказчиком" не заполнено на странице 'Сведения о дополнительном соглашении'
    #
    #               Проверка раздела [Сведения о закупке и предмете договора (дополнительного соглашения)]
    #
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Сведения о закупке и предмете договора"
    And 'Заказчик' проверят раздел дополнительного соглашения 'Сведения о закупке и предмете договора'
    #
    #                 Проверка таблицы [Позиции договора (дополнительного соглашения)] конкурентной закупки
    #
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Позиции договора конк."
    And 'Заказчик' проверяет количество строк "1" в таблице 'Позиции договора - доп.соглашения'
    And 'Заказчик' проверяет столбец "Наименование товара, работ, услуг" строка "1" таблица 'Позиции договора - доп.соглашения' конкурентной закупки текст "Товар 1"
    And 'Заказчик' проверяет столбец "Код ОКПД2" строка "1" таблица 'Позиции договора - доп.соглашения' конкурентной закупки текст "36.00.11.000"
    And 'Заказчик' проверяет столбец "Код ОКВЭД2" строка "1" таблица 'Позиции договора - доп.соглашения' конкурентной закупки текст "01.11.13"
    And 'Заказчик' проверяет столбец "Тип объекта закупки" строка "1" таблица 'Позиции договора - доп.соглашения' конкурентной закупки текст "Товар"
    And 'Заказчик' проверяет столбец "Страна происхождения" строка "1" таблица 'Позиции договора - доп.соглашения' конкурентной закупки текст "Российская Федерация"
    And 'Заказчик' проверяет столбец "Единица измерения" строка "1" таблица 'Позиции договора - доп.соглашения' конкурентной закупки текст "Ампер (260)"
    And 'Заказчик' проверяет столбец "Количество" строка "1" таблица 'Позиции договора - доп.соглашения' конкурентной закупки текст "1"
    And 'Заказчик' проверяет столбец "Цена за ед.изм." строка "1" таблица 'Позиции договора - доп.соглашения' конкурентной закупки текст "4,00 руб"
    And 'Заказчик' проверяет столбец "Стоимость" строка "1" таблица 'Позиции договора - доп.соглашения' конкурентной закупки текст "4,00 руб"
    And 'Заказчик' проверяет столбец "Дополнительные сведения" строка "1" таблица 'Позиции договора - доп.соглашения' конкурентной закупки текст " "
    And 'Заказчик' проверяет в таблице 'Позиции товара' работу кнопки 'Экспорт объектов в Excel'
    And 'Заказчик' нажимает на кнопку "Добавить позицию" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Добавление информации о товаре, работе или услуги"
    And 'Заказчик' заполняет поле "Наименование товара, работ, услуг" значением "Товар доп" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' заполняет поле Код ОКПД2 значением "36.00.11.000" на странице 'Сведения о дополнительном соглашении'
    #                                                      [Вода питьевая]
    And 'Заказчик' заполняет поле Код ОКВЭД2 значением "01.11.13" на странице 'Сведения о дополнительном соглашении'
    #                                                      [Выращивание ржи]
    And 'Заказчик' устанавливает флажок в дополнительном соглашении "Невозможно определить количество (объем)"
    And 'Заказчик' нажимает на кнопку "Добавить" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет количество строк "2" в таблице 'Позиции договора'
    #
    #                 Проверка раздела [Сведения о заказчике]
    #
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Сведения о заказчике"
    And 'Заказчик' нажимает на кнопку "Сведения о заказчике" на странице 'Сведения о дополнительном соглашении'
    And 'Пользователь' переключается на новую вкладку в браузере
    ...
    #
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Сведения об участнике закупки"
    And 'Заказчик' нажимает на кнопку "Сведения об участнике закупки" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что отображается информационное окно 'Сведения о поставщике'
    And 'Заказчик' нажимает на кнопку "Закрыть сведения о поставщике" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' нажимает на кнопку "Заявка на участие" на странице 'Сведения о дополнительном соглашении'
    And 'Пользователь' переключается на новую вкладку в браузере
    And 'Заказчик' проверяет, что открыта страница "Заявка на участие"
    And 'Пользователь' закрывает все дополнительные окна в приложении
    And 'Заказчик' нажимает на кнопку "Аккредитационные документы" на странице 'Сведения о дополнительном соглашении'
    And 'Пользователь' переключается на новую вкладку в браузере
    ...
    #
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Документы"
    ...
    #
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Многосторонее подписание"
    And 'Заказчик' проверяет, что флажок "Финальный подписант" "установлен" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' нажимает на кнопку "Наименование подписанта" на странице 'Сведения о дополнительном соглашении'
    And 'Пользователь' переключается на новую вкладку в браузере
    And 'Заказчик' проверяет, что открыта страница "Карточка заказчика"
    And 'Пользователь' закрывает все дополнительные окна в приложении
    #
    #                 Проверка сохранения доп. соглашения, внесения изменений и выгрузки информации о доп. соглашении
    #
    And 'Заказчик' нажимает на кнопку "Сохранить" на странице 'Сведения о дополнительном соглашении'
    And 'Пользователь' обновляет страницу
    ...
    And 'Заказчик' нажимает на кнопку "Внести изменения" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' нажимает на кнопку 'Продолжить' в диалоговом окне 'Предупреждение'
    And 'Заказчик' нажимает на кнопку "Изменить цену договора" на странице 'Сведения о дополнительном соглашении'
    ...
    #*******************************************************************************************************************
    #
    #                 Поставщик 1 подписывает доп. соглашение с Заказчиком
    #
    #*******************************************************************************************************************
    When "Поставщик Юридическое лицо 1" заходит в личный кабинет
    And 'Поставщик' переходит на страницу 'Мои договоры'
    And 'Поставщик' производит поиск дополнительного соглашения
    And 'Поставщик' проверяет возможность скачать файл со страницы 'Договор'
    And 'Поставщик' принимает и подписывает дополнительное соглашение
    And 'Пользователь' покидает систему
    #*******************************************************************************************************************
    #
    #                 Администратор меняет дату и время начала регламентного срока доп. соглашения на текущую
    #
    #*******************************************************************************************************************
    When "Администратор" заходит в личный кабинет
    And 'Администратор' переходит на страницу "Ускорение процедур"
    And 'Администратор' выполняет поиск по номеру закупки
    And 'Администратор' проверяет статус лота "Завершена" для лота с номером "1" без нажатия кнопки 'Обновить'
    And 'Администратор' нажимает кнопку "Начало регламентного срока договора - Текущая" в строке 2 таблицы 'Управление договорами'
    And 'Пользователь' покидает систему
    #*******************************************************************************************************************
    #
    #                 Заказчик проверяет и подписывает доп. соглашение с Поставщиком 1
    #
    #*******************************************************************************************************************
    When "Заказчик" заходит в личный кабинет
    And 'Заказчик' переходит на страницу "ДОГОВОРЫ/ДОГОВОРЫ" с именем URL для проверки "Мои контракты"
    And 'Заказчик' выполняет поиск 1 доп. соглашений по номеру извещения
    And 'Заказчик' открывает страницу 'Сведения о доп. соглашении' по ссылке на номер карточки доп. соглашения
    And 'Заказчик' проверяет, что открыта страница "Заказчик-Подпишите договор"
    #
    #               Заказчик заполняет даты начала и окнончания исполнения дополнительного соглашения
    #
    And 'Заказчик' заполняет дату и нулевое время в поле "Дата начала исполнения дополнительного соглашения" в "HOURS" со смещением "+0" от времени публикации на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' заполняет дату и нулевое время в поле "Дата окончания исполнения дополнительного соглашения" в "YEARS" со смещением "+1" от времени публикации на странице 'Сведения о дополнительном соглашении'
    #
    #               Проверка раздела [Сведения о заключении договора (дополнительного соглашения)]
    #
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Сведения о заключении договора (дополнительного соглашения)"
    And 'Заказчик' проверяет, что поле "Дата публикации протокола подведения итогов" соответствует шаблону "dd.MM.yyyy HH:mm:ss" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Дата создания карточки" соответствует шаблону "dd.MM.yyyy HH:mm:ss" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Крайний срок подписания проекта дополнительного соглашения участником закупки" не заполнено на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Дата направления дополнительного соглашения участнику" соответствует шаблону "dd.MM.yyyy HH:mm:ss" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Дата подписания дополнительного соглашения участником" соответствует шаблону "dd.MM.yyyy HH:mm:ss" на странице 'Сведения о дополнительном соглашении'
    And 'Заказчик' проверяет, что поле "Дата подписания дополнительного соглашения заказчиком" не заполнено на странице 'Сведения о дополнительном соглашении'
    #
    #               Проверка таблицы [Многостороннее подписание] (таблица скрыта)
    #
    And 'Заказчик' проверяет отсутствие раздела "Многосторонее подписание" на странице 'Сведения о доп. соглашении'
    #
    #                 Проверка подписания доп. соглашения и даты подписания
    #
    And 'Заказчик' проверяет статус дополнительного соглашения "Договор подписан участником"
    And 'Заказчик' подписывает доп. соглашение
    And 'Заказчик' проверяет, что поле "Дата подписания дополнительного соглашения заказчиком" соответствует шаблону "dd.MM.yyyy HH:mm:ss" на странице 'Сведения о дополнительном соглашении'
    #
    #                 Заказчик открывает основной договор и проверяет сведения о доп. соглашении
    #
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Сведения о договоре (дополнительном соглашении)"
    And 'Заказчик' нажимает на кнопку "Ссылка на основной договор" на странице 'Сведения о дополнительном соглашении'
    And 'Пользователь' переключается на новую вкладку в браузере
    And 'Заказчик' проверяет, что открыта страница "Заказчик-Подпишите договор"
    And 'Заказчик' переходит к просмотру раздела договора "Дополнительные соглашения"
    And 'Заказчик' проверяет, что поле "Дата создания доп. соглашения" соответствует шаблону "dd.MM.yyyy HH:mm" на странице 'Сведения о договоре'
    And 'Заказчик' нажимает на кнопку "Номер доп. соглашения" на странице 'Сведения о договоре'
    And 'Пользователь' переключается на новую вкладку в браузере
    And 'Заказчик' проверяет, что открыта страница "Заказчик-Подпишите договор"
    And 'Пользователь' закрывает все дополнительные окна в приложении
    And 'Заказчик' переходит к просмотру раздела дополнительного соглашения "Сведения о договоре (дополнительном соглашении)"
    ...
    And 'Заказчик' проверяет, что открыта страница "Заказчик-Подпишите договор"
    And 'Заказчик' переходит к просмотру раздела договора "Дополнительные соглашения"
    And 'Заказчик' проверяет что статус доп. соглашения на странице договора содержит значение "Договор заключён"
    And 'Заказчик' нажимает на кнопку "Дейстиве доп. соглашения" на странице 'Сведения о договоре'
    And 'Пользователь' переключается на новую вкладку в браузере
    And 'Заказчик' проверяет, что открыта страница "Заказчик-Подпишите договор"
    And 'Пользователь' покидает систему
