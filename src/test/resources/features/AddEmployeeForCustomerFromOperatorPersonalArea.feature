@smoke @runTest @add_employee_for_customer_from_operator_personal_area
Feature: Add Employee For Customer From Operator Personal Area
  #=====================================================================================================================
  # Добавление пользователя из личного кабинета Оператора ( Заказчик )
  # ( https://ve-lab.visualstudio.com/kontur.market/_workitems/edit/288990 )
  # В системе созданы следующие пользователи:
  # Администратор ( Оператор ) - "Администратор"
  #=====================================================================================================================
  Scenario: Добавление пользователя из личного кабинета Оператора ( Заказчик )
    ...
    #*******************************************************************************************************************
    #
    #                 Администратор открывает список пользователей организации
    #
    #*******************************************************************************************************************
    When 'Администратор' выбирает 'Реестр заказчиков' в разделе меню 'Справочники'
    ...
    #*******************************************************************************************************************
    #
    #                 Администратор добавляет нового сотрудника для организации
    #
    #*******************************************************************************************************************
    And 'Администратор' нажимает на кнопку "Добавить пользователя" на странице 'Список пользователей'
    And 'Администратор' проверяет, что открыта страница "Заявка на добавление пользователя"
    And 'Пользователь' генерирует сертификат для сотрудника ИП
    And 'Администратор' нажимает на кнопку 'Выбрать из списка' на странице 'Заявка на добавление пользователя в организацию'
    And 'Пользователь' выбирает сертификат
    ...
    And 'Администратор' нажимает на кнопку 'Отправить' на странице 'Заявка на добавление пользователя в организацию'
    And 'Администратор' проверяет, что таблица на странице 'Список пользователей' содержит 2 строки
    ...
    #
    #*******************************************************************************************************************
    And 'Заказчик' открывает страницу 'Вход в личный кабинет'
    And 'Заказчик' заходит в личный кабинет пользователем "Заказчик Сгенерированный работник"
    ...
    #*******************************************************************************************************************
    #
    #                 Сотрудник, добавленный к организации, авторизуется на площадке
    #
    #*******************************************************************************************************************
