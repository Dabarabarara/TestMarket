@smoke @runTest @tender_with_one_participant
Feature: Tender With One Participant
  #=====================================================================================================================
  # Проведение полного электронного конкурентного конкурса с одним участником
  # ( https://ve-lab.visualstudio.com/kontur.market/_workitems/edit/308842 )
  ...
  #=====================================================================================================================
  Scenario: Полный электронный конкурс с одним участником
    Given Параметру 'Тип теста' установлено значение "Full Tender With One Participant"
    ...
    And 'Заказчик А' заполняет поле 'Наименование закупки' сгенерированным именем для типа закупки "Конкурс - Конкурентн. с одним уч."
    And 'Заказчик А' заполняет поле "Описание закупки" значением "Автоматические тесты - Конкурентная закупка - Конкурс. с одним уч."
